...
export const createAnnouncementSchema=yup.object({
    title:yup.string().max(30,"Title is too long").min(5,"Title is too short").required("Title is required"),
    subTitle:yup.string().max(250,"Sub title is too long").min(10,"Sub title is too short").required("Sub title is required"),
...
export const editAnnouncementSchema=yup.object({
    ...
    subTitle:yup.string().max(250,"Sub title is too long").min(10,"Sub title is too short"),
